...
The user exports their deals from Pipedrive as an `.xlsx` file — a standard export anyone can run in two clicks — and uploads it to the tool. The report generates instantly in the browser.
...
Negative values appear in red. A summary row at the top shows total pipeline value, total GP, overhead recovery, and deal count by category.

## Technology

Everything runs in the browser. There is no backend to maintain.
